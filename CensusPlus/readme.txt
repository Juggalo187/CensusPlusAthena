Censusplus modified by Skuly for Whitemane:Maelstrom 
...
NOTE: Addons that use LibWho like WIM (WoW Instant Messenger) break CensusPlus so I would suggest using an alternative if possible, for example instead of WIM I'd use Cellular.

Whitemane Discord : https://discord.gg/whitemane
