...
CENSUSPlus_UPLOAD           = "Modified by Skuly for Twinstar:Athena";
...
CENSUSPlus_FACTION          = "Faction: ";
CENSUSPlus_FACTIONUNKNOWN   = "Faction: Unknown";
CENSUSPlus_LOCALE           = "Locale : ";
...
CENSUSPlus_TIMER			= "Auto-Census Timer: %d minutes (%s since last scan or addon loaded)";
...
CENSUSPlus_THISPROFILE_TOOLTIP = "Modified by Skuly for Twinstar:Athena";
...
elseif ( GetLocale() == "deDE" ) then
	...
	CENSUSPlus_REALMNAME        = "Server: "; 
	CENSUSPlus_REALMUNKNOWN     = "Server: Unbekannt"; 
	CENSUSPlus_FACTION          = "Fraktion: "; 
...
elseif ( GetLocale() == "esES" ) then
	...
	CENSUSPlus_FACTION          = "Facción: ";
	CENSUSPlus_FACTIONUNKNOWN   = "Facción: Desconocida";
	CENSUSPlus_LOCALE           = "Región : ";
...
CENSUSPlus_REALMNAME        = "서버: ";
CENSUSPlus_REALMUNKNOWN     = "서버: 알수없음";
CENSUSPlus_FACTION          = "진영: ";
